...
export default function Home() {
  return <main className="fp-home">
    ...
    <section className="fp-equantum-wrap"><div className="fp-equantum fp-section"><Reveal><div><p className="fp-script">Emprendimiento</p><h2>eQuantum<br/><span>Consulting Group</span></h2><p>Ayudamos a empresas a crecer en el mundo digital con estrategia, datos, ecommerce y tecnología.</p><a href="https://www.equantum.com.py/" target="_blank" rel="noreferrer">Conocer más</a></div></Reveal><div className="fp-dashboard-art"><div className="fp-board"><span/><strong>Resultados</strong><i/><i/><i/></div><b/><b/></div></div></section>
