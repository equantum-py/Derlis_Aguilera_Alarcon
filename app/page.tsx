      ...
      <section className="hero section" id="top">
        <Reveal>
          ...
          <div className="actions">
            <a className="button primary desktop-only" href={`https://wa.me/${contact.whatsapp}`}>WhatsApp</a>
      ...
      <section className="section contact" id="contact">
        <Reveal>
          ...
          <div className="contact-links">
            ...
            <a href={`mailto:${contact.email}?subject=Solicitud%20de%20CV%20-%20Derlis%20Aguilera`}>Descargar CV</a>
          </div>
