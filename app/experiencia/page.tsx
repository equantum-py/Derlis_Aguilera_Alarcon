...
const ownedProjects = projects.filter((project) =>
  ["Marmolería Pietra", "Corpicia"].includes(project.title)
);
  ...
  return (
    <main>
      ...
      <section className="section page-hero">
        ...
        <Reveal>
          ...
          <p className="hero-copy">
            Detalle de roles, responsabilidades y proyectos donde participé
            desde operación ecommerce, coordinación, analítica, automatización o
            creación web.
          </p>
        </Reveal>
      </section>
      ...
      <section className="section" id="experience">
        <Reveal>
          <p className="eyebrow">Experiencia laboral detallada</p>
      ...
      <section className="section" id="projects">
        <Reveal>
          <p className="eyebrow">Trabajos realizados por mí / eQuantum</p>
          <h2>Proyectos creados y desarrollados.</h2>
        </Reveal>
