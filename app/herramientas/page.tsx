  ...
  return (
    <main>
      ...
      <nav className="nav">
        ...
        <div><a href="/">Resumen</a><a href="/experiencia">Experiencia</a><a href="#contact">Contacto</a></div>
      </nav>
      ...
      <section className="section contact" id="contact">
        <Reveal>
          ...
          <div className="contact-links"><a href={`https://wa.me/${contact.whatsapp}`}>WhatsApp</a><a href={`mailto:${contact.email}`}>Email</a><a href={contact.linkedin} target="_blank" rel="noreferrer">LinkedIn</a></div>
